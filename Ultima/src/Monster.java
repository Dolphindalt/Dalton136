 ...
 * 
 * @author Dalton Caron - student completing assignment 
 * @version 2/21/2018
 */
public class Monster implements Runnable
{
	...
	public void run()
	{
		while (hp > 0)
		{
			try 
			{
				// Make the thread pause between moves
			...
			// When not paused, choose a random direction and try to move there
			int n = (int)(Math.random() * 4);
			switch(n)
			{
			case 0:
				world.monsterMove(getX() + 1, getY(), this);
				break;
			case 1:
				world.monsterMove(getX() - 1, getY(), this);
				break;
			case 2:
				world.monsterMove(getX(), getY() + 1, this);
				break;
			case 3:
				world.monsterMove(getX(), getY() - 1, this);
				break;
